 ...
 * linker_rp2350.ld). Same reserved-offset convention as src_2040/fs.c, just
 * against this board's 16MB W25Q128JV flash instead of the RP2040 build's
 * 8MB part (see rp2350_hardware_facts memory note). */
